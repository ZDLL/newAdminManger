  ...
  <div class="addbanner">
    ...
    <div class="addbanner-cont">
      <div class="addBanner-warp">
        <proUpload :key="postData.picture_url" :imgUrl="postData.picture_url" @getUrl="getImgUrl"></proUpload>
        ...
        <!-- <myPload up-type='1' @getFile="fileUrlFun"></myPload> -->
...
export default {
  ...
  data() {
    return {
      bannerTxt: "",
      // t:"广告位管理",
      brea:[{"txt":"社交中心","url":"/"},{"txt":"添加广告","url":"/"}],
      options: [],
      pageOptions: [
        {
          id: "2",
