      ...
      <div class="user-table">
        <div class="seachTop">
          <div class="seachlist dis_inl_blo mr20">
            <span>昵称：</span>
            <el-input style="width:200px" clearable @clear="clearBtn" placeholder="请输入内容"></el-input>
          </div>
          <div class="seachlist dis_inl_blo mr20">
            <span>性别：</span>
          ...
          <el-button class="fr" type="primary" plain>查询</el-button>
        </div>
        <!-- <el-divider content-position="left">企业用户列表</el-divider> -->
        <div class="cloum-table mt20">
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="codeTypeCpltId" label="用户ID"></el-table-column>
            <el-table-column prop="codeTypeCpltName" label="姓名"></el-table-column>
            <el-table-column prop="codeTypeCpltName" label="关联门店数"></el-table-column>
            <el-table-column prop="codeTypeCpltName" label="添加时间"></el-table-column>
            ...
            <el-table-column fixed="right" label="操作" width="100">
              <template slot-scope="scope">
                <el-button
                  type="text"
                  size="small"
                >{{scope.row.state | statusBtnTxt}}员工</el-button>
                <!-- <el-button type="text" size="small"></el-button> -->
                <el-button type="text" size="small">编辑员工</el-button>
              </template>
            </el-table-column>
          </el-table>
          <myPackage
