         ...
         <div class="wrapper">
            ...
            <div class="show-info">
                <div class="test">
                    ...
                    :fixedNumber="example2.fixedNumber" :enlarge="1">
                    </vueCropper>
                </div>
    ...
    methods:{
      ...
      finish2() {
        this.$refs.cropper2.getCropData((data) => {
          ...
          let blob= this.toBlob(data);
          let files = new window.File([blob], blob.name, {type: blob.type})
          this.upImg(files,function(url){
            console.log(url)
          })
        })
